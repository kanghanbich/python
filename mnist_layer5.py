...
#W_conv3 = weight_variable([5, 5, 64, 128]), 두번째 합성곱 계층
#5*5 크기, 64개의 필터, 입력 채널의 수, 출력 채널의 수
W_conv3=tf.get_variable("W3", shape=[5, 5, 64, 128],
                     initializer=tf.contrib.layers.xavier_initializer())
...
#W_conv4 = weight_variable([5, 5, 128, 256]), 두번째 합성곱 계층
#5*5 크기, 64개의 필터, 입력 채널의 수, 출력 채널의 수
W_conv4=tf.get_variable("W4", shape=[2, 2, 128, 256],
                     initializer=tf.contrib.layers.xavier_initializer())
...
#W_conv5 = weight_variable([5, 5, 256, 512]), 두번째 합성곱 계층
#5*5 크기, 64개의 필터, 입력 채널의 수, 출력 채널의 수
W_conv5=tf.get_variable("W5", shape=[2, 2, 256, 512],
                     initializer=tf.contrib.layers.xavier_initializer())
...
h_pool3_flat = tf.reshape(h_pool5, [-1, 1*1*512])
